...
public class Main extends JavaPlugin {
	...
	// onCommand is a method that runs when any player runs ANY command (even if it
	// doesn't exist.) EX: /hello
	...
	public void healPlayer(Player playerToBeHealed) {
		playerToBeHealed.sendMessage(ChatColor.GRAY + "Hello, " + ChatColor.GREEN + playerToBeHealed.getName()
